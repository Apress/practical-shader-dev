...
void ofApp::setup() {
	...
	//use the code below to load the second skybox from the book
	/*
	...
	*/
	...
	cam.pos = glm::vec3(0, 0.75f, 0.85f);
...
void ofApp::drawWater(DirectionalLight& dirLight, glm::mat4& proj, glm::mat4& view)
{
	...
	//if you're using cube2, set ambient to 0.05, 0.05, 0.05 to match 
	//the figures in the book

	shd.setUniform3f("ambientCol", glm::vec3(0.2, 0.2, 0.2));
